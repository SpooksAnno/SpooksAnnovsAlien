...
#define JOB_DISPLAY_ORDER_NM_CHIEF_EXECUTIVE_OFFICER 10
#define JOB_DISPLAY_ORDER_CORPORATE_LIAISON 11
#define JOB_DISPLAY_ORDER_SYNTHETIC 12
#define JOB_DISPLAY_ORDER_AI 13
#define JOB_DISPLAY_ORDER_TRANSPORT_OFFICER 14
#define JOB_DISPLAY_ORDER_CHIEF_ENGINEER 15
...
#define NTC_CHIEF_EXECUTIVE_OFFICER "NTC Chief Executive Officer"
#define NM_CHIEF_EXECUTIVE_OFFICER "NovaMed Chief Executive Officer"
...
GLOBAL_LIST_INIT(jobs_officers, list(CAPTAIN, EXECUTIVE_OFFICER, NTC_CHIEF_EXECUTIVE_OFFICER, NM_CHIEF_EXECUTIVE_OFFICER, FIELD_COMMANDER, CORPSEC_COMMANDER, STAFF_OFFICER, PILOT_OFFICER, TRANSPORT_OFFICER, MECH_PILOT, ASSAULT_CREWMAN, TRANSPORT_CREWMAN, CORPORATE_LIAISON, SYNTHETIC, SILICON_AI))
...
GLOBAL_LIST_INIT(jobs_som, list(SOM_SQUAD_MARINE, SOM_SQUAD_VETERAN, SOM_SQUAD_ENGINEER, SOM_SQUAD_CORPSMAN, SOM_SQUAD_LEADER, , SOM_STAFF_OFFICER, SOM_COMMANDER, SOM_SQUAD_SLUT, SOM_PILOT_OFFICER, SOM_MECH_PILOT, SOM_REQUISITIONS_OFFICER, SOM_CHIEF_MEDICAL_OFFICER, SOM_TECH, SOM_MEDICAL_DOCTOR, SOM_CHEF, "Sons of Mars Representative"))
GLOBAL_LIST_INIT(jobs_regular_all, list(CAPTAIN, EXECUTIVE_OFFICER, SECURITY_OFFICER, NTC_CHIEF_EXECUTIVE_OFFICER, NM_CHIEF_EXECUTIVE_OFFICER, FIELD_COMMANDER, CORPSEC_COMMANDER, STAFF_OFFICER, PILOT_OFFICER, TRANSPORT_OFFICER, MECH_PILOT, REQUISITIONS_OFFICER, CHIEF_SHIP_ENGINEER, \
CHIEF_MEDICAL_OFFICER, SYNTHETIC, SILICON_AI, CORPORATE_LIAISON, SHIP_TECH, ASSAULT_CREWMAN, TRANSPORT_CREWMAN, VANGUARD, \
