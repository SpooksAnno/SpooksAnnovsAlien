...
DEFINE_BITFIELD(caste_flags, list(
	...
	"CASTE_HAS_WOUND_MASK" = CASTE_HAS_WOUND_MASK,
	"CASTE_EVOLUTION_ALLOWED" = CASTE_EVOLUTION_ALLOWED,
	"CASTE_INSTANT_EVOLUTION" = CASTE_INSTANT_EVOLUTION,
	"CASTE_CANNOT_EVOLVE_IN_CAPTIVITY" = CASTE_CANNOT_EVOLVE_IN_CAPTIVITY,
	"CASTE_REQUIRES_FREE_TILE" = CASTE_REQUIRES_FREE_TILE,
	"CASTE_LEADER_TYPE" = CASTE_LEADER_TYPE,
...
DEFINE_BITFIELD(use_state_flags, list(
	...
	"ABILITY_USE_HANDCUFFED" = ABILITY_USE_HANDCUFFED
))
...
DEFINE_BITFIELD(round_type_flags, list(
	...
	"MODE_APC_ALL_ACCESS" = MODE_APC_ALL_ACCESS,
	...
	"MODE_ALLOW_MARINE_QUICKBUILD" = MODE_ALLOW_MARINE_QUICKBUILD,
	"MODE_XENO_GRAB_DEAD_ALLOWED" = MODE_XENO_GRAB_DEAD_ALLOWED,
	"MODE_BUFFED_XENO_ABILITIES" = MODE_BUFFED_XENO_ABILITIES,
	"MODE_ALAMO_ONLY" = MODE_ALAMO_ONLY,
	"MODE_ENCOUNTER" = MODE_ENCOUNTER,
))
DEFINE_BITFIELD(round_type_flags2, list(
	"MODE_2_CAMPAIGN_LITE_SUPPORT" = MODE_2_CAMPAIGN_LITE_SUPPORT,
	"MODE_2_NO_GHOSTS" = MODE_2_NO_GHOSTS,
	"MODE_2_NO_ABDUCT" = MODE_2_NO_ABDUCT,
	"MODE_2_SURVIVAL" = MODE_2_SURVIVAL,
	"MODE_2_NO_GHOSTS_STRICT" = MODE_2_NO_GHOSTS_STRICT,
	"MODE_2_SINGLE_USE_NUKE_DISK_GENERATOR" = MODE_2_SINGLE_USE_NUKE_DISK_GENERATOR,
	"MODE_2_CHILL_RULES" = MODE_2_CHILL_RULES,
	))
